...
#   - param2: dtype parameter, specifies the data type of the input tensor : Range = ['torch.float32', 'torch.float64', 'torch.float16', 'torch.bfloat16', 'torch.complex64', 'torch.complex128'] : Type = torch.dtypeparam1 = int(700)
