...
#   - param2: initialization values, can be a list, tuple or other iterable containing valid short integers : Range = [-32768, 32767] : Type = list/tuple of intparam1 = int(1)
param2 = list([0])
