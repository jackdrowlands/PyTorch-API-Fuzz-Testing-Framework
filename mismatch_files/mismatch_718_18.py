...
#   - param4: tensor or scalar to compare against : Range = Any scalar/tensor that matches or broadcasts with input_tensor's shape : Type = scalar or torch.Tensorparam1 = int(200)
param2 = int(200)
