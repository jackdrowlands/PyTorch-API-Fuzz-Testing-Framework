...
#   - param4: 'other' value which can be a scalar or a tensor : Range = [any numeric value] : Type = float/int (scalar) or tensorparam1 = int(1500)
param2 = int(1500)
param3 = torch.float64
param4 = torch.tensor(5.0, dtype=torch.float64)
