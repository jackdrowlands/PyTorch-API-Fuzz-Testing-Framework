...
#   - param5: probability of an element being zeroed (p) : Range = [0.0, 1.0] : Type = float
#   - param6: boolean flag indicating whether the layer is in training mode : Range = [True, False] : Type = bool
#   - param7: boolean flag indicating whether to perform the operation in-place : Range = [True, False] : Type = boolparam1 = int(256)
param2 = int(128)
param3 = int(64)
