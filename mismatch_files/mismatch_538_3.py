...
#   - param6: dtype parameter, optional, specifies the data type of the input tensor : Range = ['torch.float32', 'torch.float64', 'torch.float16', 'torch.bfloat16'] : Type = torch.dtypeparam1 = float(0.05)
param2 = float(0.99)
param3 = bool(True)
param4 = int(1000)
param5 = int(1000)
