...
#   - param4: tensor or scalar to compare against : Range = Any scalar/tensor that matches or broadcasts with input_tensor's shape : Type = scalar or torch.Tensorparam1 = int(128)
param2 = int(64)
param3 = torch.float32
param4 = torch.tensor(3.3)
